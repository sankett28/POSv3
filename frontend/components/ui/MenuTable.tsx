    ...
    <div className="bg-white rounded-2xl shadow-lg border border-[#E5E7EB] overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <div className="min-w-full leading-normal">
          <div className="bg-gradient-to-r from-[#B45A69]/25 to-[#B45A69]/15 grid grid-cols-[2.5fr_1fr_2fr_1fr_0.8fr] sm:grid-cols-[2.5fr_1fr_2fr_1fr_0.8fr] px-6 py-4 text-sm font-bold text-[#610027] uppercase tracking-wider border-b-2 border-[#B45A69]/30">
          ...
          <div>
            {products.length === 0 ? (
              ...
              products.map((product, index) => (
                <div 
                  key={product.id} 
                  className={`grid grid-cols-[2.5fr_1fr_2fr_1fr_0.8fr] sm:grid-cols-[2.5fr_1fr_2fr_1fr_0.8fr] px-6 py-4 items-center border-b border-[#E5E7EB]/50 transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-[#FFF0F3]/30 hover:to-[#FFF0F3]/10 hover:shadow-sm hover:border-[#B45A69]/20 ${
